  ...
  return (
    <>
      <div style={{ backgroundColor: "lightblue", marginTop: "100px", padding: "100px" }}>
        <h1>البحث على السور حسب عدد الآيات</h1>
        <input type="number" value={saisie1} name="min" onChange={handleChange1} />
        <br />
        <input type="number" value={saisie2} name="max" onChange={handleChange2} />
        <br />
